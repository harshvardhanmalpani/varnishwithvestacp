###############################################################################################
### Varnish 4.x+ configuration for Joomla, WordPress & other CMS based websites ###
###############################################################################################

######################
#
# Many thanks to Fotis Evangelou @fevangelou
...
backend default {
    .host = "xxx.xx.1.208"; # UPDATE this as private IP of your server
    .port = "8445";      # UPDATE 8445 with your web server's (internal) port
}
...
*/
	...
	# Thanks to https://stackoverflow.com/users/628700/sidonaldson
	# Answer https://stackoverflow.com/a/35898184/2229148
    if (req.url !~ "wp-admin") {
